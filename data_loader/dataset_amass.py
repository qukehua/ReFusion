...
class DatasetAMASS:
    ...
    def __init__(self, mode, t_his=30, t_pred=120, use_vel=False):
        ...
        self.mode = mode
        if mode == 'train':
            self.data_file = os.path.join('/data3/user/qkh/DATASET/TransFusion/', 'data_3d_amass.npz')
        elif mode == 'test':
            self.data_file = os.path.join('/data3/user/qkh/DATASET/TransFusion/', 'data_3d_amass_test.npz')
        self.t_his = t_his
        self.t_pred = t_pred
